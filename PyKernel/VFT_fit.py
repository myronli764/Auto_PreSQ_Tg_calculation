...
parser.add_argument('-n_next',dest='n_nt',type=float,help='n_window_next')
parser.add_argument('-np_next',dest='np_nt',type=int,help='n_points_next')
...
y=args.tau
n_window=args.n
n_window_next=args.n_nt
n_points_next=args.np_nt
